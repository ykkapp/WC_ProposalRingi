                ...
                children: [
                    {
                        ...
                        details: {
                            ...
                            concurrentProposals: [],
                            applicationContent: '表題の件につきまして、下記にて貸付申請を致します。\n\n氏名：XXX\n社員番号：XXXXXXXX\n入社日：202X年X月X日\n稼働先：株式会社XX　XX事業所\n貸付希望日："＊＊＊"　≪ex.即日 or X月X日≫\n貸付希望金額：XX,000-\n返済方法："＊＊＊""　≪ex.派遣先のXXXに対し派遣料金と合わせて請求（202X年X月X日）≫\n\n【貸付金内訳】\n合計：XX,000-\n内訳：下記参照\n　XXX代：XX,000-\n　XXX代：XX,000-\n　XXX代：XX,000-\n\n【貸付発生経緯】"＊＊＊"\n＝＝\nご裁可の程、よろしくお願い致します。',
                        },
                    },
                    {
                        title: "20万円を超える",
                ...
                children: [
                    {
                        ...
                        url: "https://sites.google.com/nareru-group.co.jp/ringi-36/%E3%83%9B%E3%83%BC%E3%83%A0",
                        details: {
                ...
                children: [
                    {
                        ...
                        url: "https://sites.google.com/nareru-group.co.jp/ringi-37/%E3%83%9B%E3%83%BC%E3%83%A0",
                        details: {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        details: {
                            ...
                            concurrentProposals: [],
                            applicationContent: "表題の件につきまして、下記にて死亡退職に関する申請を致します。\n\n社員氏名：XXXX\n社員番号：XXXXXXXX\n配属先：株式会社XX\n雇用契約期間：XXXX年XX月XX日～XXXX年XX月XX日\n最終出勤日：XXXX年XX月XX日\n逝去日：XXXX年XX月XX日\n相続人からの給与誓約書取得予定日：XXXX年XX月XX日≪取得済みの場合はPDFを添付してください≫\n\n＝＝\nご裁可の程、よろしくお願い致します。",
                        },
                    },
                    {
                        title: "不備の処理を依頼する",
                ...
                children: [
                    {
                        ...
                        details: {
                            ...
                            applicationContent: "表題の件につきまして、下記にて{個別給与改定 / 派遣先賞与支給}に関する申請を致します。\n\n技術者名：XX\n社員番号：XXXXXXXX\n入社日：202X/X/X\n配属先：株式会社XX\n支給希望日：202X/X/X　※賞与の場合\n変更日：202X/X/X　X月X日支給分より　※給与の場合\n変更前金額：XXX円\n変更後金額：XXX円\n\n{賞与の場合}\n理由：支給漏れ・計算ミスがあったため・派遣先の希望による支給\n\n{給与の場合}\n理由：\n給与不満があったためXX手当に上乗せ（{上記派遣先 / 現場}に限り支給をお願い致します）\n≪ex.- 携帯電話の貸与ができないため通信費の上乗せとして特別手当にXX円を支給してください≫\n≪ex.- 通勤距離が長いため通勤手当の上乗せとして特別手当にXX円を支給してください≫\n≪ex.- 宿泊業務になるため(1日500円*20日＝10,000円)の上乗せとして特別手当にXX円を支給してください≫\n（※添付必須）\n\n＝＝\nご裁可の程、よろしくお願い致します。",
                        },
                    },
                    {
                        title: "事業部変更を伴わず、「特別手当支給」を行う",
                        ...
                        details: {
                            ...
                            applicationContent: "表題の件につきまして、下記にて{特別定期昇給 / 特別賞与支給}に関する申請を致します。\n\n技術者名：XX\n社員番号：XXXXXXXX\n入社日：202X/X/X\n配属先：株式会社XX\n支給希望日：202X/X/X　※賞与の場合\n変更日：202X/X/X　X月X日支給分より　※給与の場合\n変更前金額：XXX円\n変更後金額：XXX円\n\n{賞与の場合}\n理由：支給漏れ・計算ミスがあったため・派遣先の希望による支給\n\n{給与の場合}\n理由：\n給与不満があったためXX手当に上乗せ（{上記派遣先 / 現場}に限り支給をお願い致します）\n≪ex.- 携帯電話の貸与ができないため通信費の上乗せとして特別手当にXX円を支給してください≫\n≪ex.- 通勤距離が長いため通勤手当の上乗せとして特別手当にXX円を支給してください≫\n≪ex.- 宿泊業務になるため(1日500円*20日＝10,000円)の上乗せとして特別手当にXX円を支給してください≫\n（※添付必須）\n\n＝＝\nご裁可の程、よろしくお願い致します。",
                        },
                    },
                ],
            },
...
export const SPECIAL_REQUEST_DATA = [
    {
